    ...
    <div class="w-100 row ml-0 mr-0375">
      ...
      <div class="Footer__mapWrapper pr-0 col-7 d-none d-lg-flex justify-content-end">
        ...
        <iframe class="Footer__map"
                src="https://yandex.ru/map-widget/v1/?um=constructor%3Ae792fd065822555c97bfbd0576e0b12e270e7e702d31b248218857825ee63a71&amp;source=constructor"
                width="500" height="359" frameborder="0"></iframe>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    let payment = document.createElement('script')
    payment.setAttribute('src', 'https://widget.cloudpayments.ru/bundles/cloudpayments')
